...
for i, zone in enumerate(df["zone"].unique()):
    ...
    ax.plot(z["month"], z["tas_mean"], marker='o', markersize=3.5, 
            color=colors[i], linestyle='none', markerfacecolor='white',
            markeredgewidth=0.7, zorder=3)

# Add title
ax.set_title('Historical Monthly Mean Temperature by Region', fontsize=13, fontweight='normal', pad=15)
...
plt.tight_layout()
plt.savefig("results/figures/monthly_temperature_hist.png", dpi=300, bbox_inches='tight', 
            facecolor='white', edgecolor='none')
print("✅ Monthly temperature plot saved to results/figures/monthly_temperature_hist.png")
